  ...
  return (
    <>
      <section className="flex items-stretch min-h-screen text-white ">
        <div
          className="relative items-center hidden w-1/2 bg-gray-500 bg-no-repeat bg-cover lg:flex"
          style={{
            backgroundImage:
        ...
        <div
          className="z-0 flex items-center justify-center w-full px-0 text-center lg:w-1/2 md:px-16"
        ...
        >
          ...
          <div className="z-20 w-full py-6">
            <h1 className="my-6">
              <svg
                viewBox="0 0 247 31"
                className="inline-flex w-auto h-7 sm:h-8"
              >
                <path
            ...
            <form className="w-full px-4 mx-auto sm:w-2/3 lg:px-0">
              ...
              <div className="px-4 pt-4 pb-2">
                <button
                  className="block w-full p-4 text-lg uppercase bg-indigo-500 rounded-full hover:bg-indigo-600 focus:outline-none"
                  onClick={handleSubmit(handleDoSubmit)}
                >
                  Login
                </button>
              </div>
